...
- [ ] **Session context summary** — after each conversation, surface a 2–3 line summary in the dashboard ("What we discussed today")

---

## P1 — User Journey Completeness

- [ ] **Coaching goals setting** — user sets 1–3 coaching goals in the web app; bot uses them to steer conversations
- [ ] **Progress timeline** — weekly/monthly view of trait changes and goal progress inferred from conversation history
