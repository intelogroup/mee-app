...
- [x] **Memory reset / privacy controls** — let user clear their coaching history and Pinecone vectors from the web app
- [x] **Re-engagement nudge** — if user hasn't interacted in 7 days, bot sends a gentle prompt
